...
<html>
    <head>
        ...
        <noscript><link rel="stylesheet" href="views/assets/css/noscript.css" /></noscript>
    </head>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="views/images/slider-image-1-1920x700.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="views/images/slider-image-2-1920x700.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="views/images/slider-image-3-1920x700.jpg" alt="Third slide">
                        </div>
                    </div>
                ...
                <div class="inner">
                    ...
                    <section class="tiles">
                        ...
                        <article class="style2">
                            <span class="image">
                                <img src="views/images/other-2-720x480.jpg" alt="" />
                            </span>
                            <a href="views/offers.html">
                                <h2>Lorem ipsum dolor sit amet, consectetur</h2>
                        ...
                        <article class="style3">
                            <span class="image">
                                <img src="views/images/other-3-720x480.jpg" alt="" />
                            </span>
                            <a href="views/offers.html">
                                <h2>Lorem ipsum dolor sit amet, consectetur</h2>
                    ...
                    <p class="text-center"><a href="views/offers.html">View Offers &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
                    ...
                    <!-- Fleet -->
                    <section class="tiles">
                        <?php while ($row = $fleet->fetch_assoc()) { ?>
                    ...
                    <p class="text-center"><a href="views/fleet.php">View Fleet &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
                    ...
                    <div class="row">
                        <div class="col-sm-4 text-center">
                            <img src="views/images/blog-1-720x480.jpg" class="img-fluid" alt="" />
                        ...
                        <div class="col-sm-4 text-center">
                            <img src="views/images/blog-2-720x480.jpg" class="img-fluid" alt="" />
                        ...
                        <div class="col-sm-4 text-center">
                            <img src="views/images/blog-3-720x480.jpg" class="img-fluid" alt="" />
                    ...
                    <p class="text-center"><a href="views/testimonials.html">Read More &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
                </div>
            </div>
